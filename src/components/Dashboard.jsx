            ...
            return (
              <button
                ...
                style={{
                  ...
                  color: activeTab === tab.id ? colors.verdePrimario : colors.doradoClaro
                }}
              >
                <Icon className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" />
                <span className="font-medium text-xs sm:text-sm">{tab.label}</span>
                {activeTab === tab.id && (
                  <div className="ml-auto w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full" style={{ backgroundColor: colors.verdePrimario }}></div>
                )}
              </button>
            );
          })}
